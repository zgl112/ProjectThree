    ...
    return (
        ...
        <Card fluid style={{borderTop: "3px rgb(33, 138, 174) solid" }}>
          <Card.Content>
            ...
            />
   */}
            <Header as="h1" style={{marginBottom: "0px"}}>Job Title Placeholder</Header>
...
<Segment style={{ marginTop: "25px", backgroundColor: "#F7F8FA"}}><Grid>
  <GridRow>
    <GridColumn width="8">
      <GridRow>
        <Header as="h5">
...
<br />
<Card.Description >
JOB TITLE - Reception Teacher, Enfield, September 2020

ABOUT THE SCHOOL

Prospero Teaching is looking for a Reception Teacher for an Ofsted "Good" Primary school in Enfield, North London.

The school is a vibrant two-form entry mainstream Primary School with a supportive senior leadership team. The school is going from strength to strength and providing training to all staff.

The position is open to both NQT's and experienced teachers. Depending on performance the school would look at either extending the contract or offering a permanent position.
...
Contract or position start date - 3rd September 2020
Duration / Likely Duration - 2 terms until end of the academic year July 2021
Contract or position end date (if applicable) - July 2021
Contract type (temp/perm/temp to perm) - Temporary, long term
Full time/part time - Full time
Minimum rate of pay - Minimum rate £130 per day / paid to scale
Hours - 8:30 am - 4pm : Mon - Fri (term time only)
EXPERIENCE, TRAINING AND QUALIFICATIONS

QTS or equivalent
Minimum 1 year Key Stage 2 teaching experience in the UK
